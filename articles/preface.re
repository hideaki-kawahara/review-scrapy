...
@<b>{次のrobotsの指定されているmetaタグが1つでも存在するWebサイト注意が必要です！}@<br>{}
...
次のような記述があればスクレイピングを拒否する設定なのでWebスクレイピングを行うことは絶対に控えてください。
...
この書籍は2020年12月25日時点でのサイト情報をスクレイピングしております。それ以降にサイト更新が行われたとき正常にスクレイピングできなくなることがあります。