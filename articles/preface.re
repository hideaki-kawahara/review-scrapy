...
=== 過剰なアクセスに関する注意
Webスクレイピングはリクエストの仕方によっては短時間に大量のアクセスをしてしまうことがあり、Webサイトに対して過剰なアクセスで迷惑をかけることになります。開発時はスクレイピングのキャッシュを有効（@<hd>{first-step|Scrapyの設定}にて記載）にしてできるだけ過剰なアクセスをしないように心がけてください。
